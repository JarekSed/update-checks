""" This module gets the latest version of pymetar from PyPi"""
import urllib2
import re
from BeautifulSoup import BeautifulSoup
def get_version():
    """ Gets the latest version of pymetar from PyPi. Returns the version as
    a string, or False if it can't be found"""
    url = "https://pypi.python.org/pypi/pymetar"
